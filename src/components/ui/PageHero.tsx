...
export function PageHero({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-b from-ink/55 via-ink/35 to-ink/55"
        aria-hidden="true"
      />
      <div className="animate-fade-up relative z-10 mx-auto max-w-4xl px-6 pt-24 pb-12 text-center text-white">
        ...
        <h1 className="font-display text-h1 md:text-display leading-[1.05] text-balance">
          {title}
        </h1>
        {subtitle && (
