...
const BOOK_URL =
  'https://staahmax.staah.net/be/index_be?propertyId=NjI5Mg==&individual=true'
...
export const ROOMS: Room[] = [
  {
    ...
    title: 'Grand Deluxe',
    summary:
      'A super king suite of hand-carved Balinese woodwork, green marble and a black stone bathtub overlooking the garden.',
    body: [
    ...
    amenities: [
      ...
      {
        heading: 'Available upon request',
        items: ['Yoga mat', 'Iron and ironing board'],
      },
    ],
    gallery: [
      {
    ...
    variants: [
      {
        slug: 'with-balcony',
        title: 'Grand Deluxe with Balcony',
        view: 'Balcony',
        blurb:
      ...
      {
        slug: 'terrace-garden-view',
        title: 'Grand Deluxe Terrace Garden View',
        view: 'Garden View',
        blurb:
      ...
      {
        slug: 'terrace-paddy-view',
        title: 'Grand Deluxe Terrace Paddy View',
        view: 'Paddy View',
        blurb:
  ...
  {
    slug: 'prestige-pool-villa',
    family: 'prestige-pool-villa',
    title: 'Prestige Pool Villa',
    summary:
      'A two-storey glass-wood-stone villa with a private pool, kitchenette and super king bedrooms under vaulted ceilings, with near 360-degree paddy views.',
    body: [
    ...
    variants: [
      {
        slug: 'garden-view',
        title: 'Prestige Pool Villa Garden View',
        view: 'Garden View',
        blurb:
      ...
      {
        slug: 'paddy-view',
        title: 'Prestige Pool Villa Paddy View',
        view: 'Paddy View',
        blurb:
...
export const ROOM_BY_SLUG = Object.fromEntries(ROOMS.map((r) => [r.slug, r]))
